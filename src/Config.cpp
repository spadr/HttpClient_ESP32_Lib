...
namespace ConfigExample
{
    ...
    const char *api_url = "https://canaspad_project_in_supabase";
    ...
    const char *isrg_root_x1 = "-----BEGIN CERTIFICATE-----\n" // Expiration: 2035-06-04 11:04:38 UTC
                               ...
                               "WhcNMzUwNjA0MTEwNDM4WjBPMQswCQYDVQQGEwJVUzEpMCcGA1dQQChMgSW50ZXJu\n"
                               ...
                               "TkXWStAmzOVyyghqpZXjFaH3pO3JLF+l+/+sKAIuvtd7u+Nxe5AW0wdeRlNwdC\n"

...
{
    Serial.println("Testing HTTP GET with e2e.canaspad.net");

    ClientOptions options;
    HttpClient client(options, false);

    Request request;
    request.setUrl("http://e2e.canaspad.net/get")
...
{
    Serial.println("Testing HTTP POST with e2e.canaspad.net");
    ...
    Request request;
    request.setUrl("http://e2e.canaspad.net/post")
...
void test_request_timeout()
{
    ...
    Request request;
    request.setUrl("http://e2e.canaspad.net/delay/10") // 10 second delay
        .setMethod(HttpMethod::GET)
        .addHeader("X-E2E-Token", Config::e2e_token);
...
void test_redirect_following()
{
    ...
    Request request;
    request.setUrl("http://e2e.canaspad.net/redirect/2") // 2 redirects
        .setMethod(HttpMethod::GET)
        .addHeader("X-E2E-Token", Config::e2e_token);
...
void test_large_response()
{
    ...
    Request request;
    request.setUrl("http://e2e.canaspad.net/bytes/10240") // 10KB response
        .setMethod(HttpMethod::GET)
        .addHeader("X-E2E-Token", Config::e2e_token);
